...
import { NaveBarColorContext, NaveBarContext } from '../../context/NaveContext';

const Navbar = () => {
  const navGreenRef = useRef(null);
  const [navOpen, setNavOpen] = useContext(NaveBarContext)
  const [navColor, setNavColor] = useContext(NaveBarColorContext)
  ...
  return (
    <div className='flex fixed top-0 w-full justify-between items-start z-10'>
      ...
      className='lg:h-16 h-10 relative bg-black  lg:w-[16vw] w-40'>

      <div ref={navGreenRef} className='transition-all h-0 w-full top-0 absolute bg-[#D3FD50]'></div>
